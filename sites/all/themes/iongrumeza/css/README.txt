...
To use these stylesheets, rename the files and iongrumeza with the name of your theme.
...
iongrumeza-alpha-default-narrow.css  
...
iongrumeza-alpha-default-normal.css
...
iongrumeza-alpha-default-wide.css
